...
* AI가 코드를 작성하거나 수정안을 제시한 후 Commit Message를 작성할 때는 작업의 맥락을 상세하게 확인 가능하도록 변경사항을 작성하며 다음 Conventional Commits 형식을 따른다.
* 형식: `feat|fix|docs|refactor|test: [작업 영역] 작업 내용 상세 (#이슈번호)`
