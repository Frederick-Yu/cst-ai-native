# **고객사 통합 이력 관리 시스템 구현 가이드 (Next.js)**
...
DATABASE\_URL="postgres://\[USER\]:\[PASSWORD\]@db.prisma.io:5432/postgres?sslmode=require"
