...
import { PasswordRevealDialog } from "@/domains/customer/components/password-reveal-dialog";
import * as auditActions from "@/domains/audit/actions/audit.actions";
...
jest.mock("@/domains/audit/actions/audit.actions", () => ({
